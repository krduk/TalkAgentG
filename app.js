...
function getMockResponse(text) {
    ...
    if (normText.includes("選択") || normText.includes("選ぶ") || normText.includes("選んで") || 
        ...
        return "了解だよ！音楽ファイルを選択できるように画面にボタンを表示するね！iOSの場合は、著作権保護やOSの制限でミュージックアプリ内の曲は選べないから、ファイルアプリ（iCloud Driveや「このiPhone内」など）に置いた音楽ファイル（mp3/m4a等）を選んでみてね！ [SELECT_FILES_TRIGGER]";
    }
